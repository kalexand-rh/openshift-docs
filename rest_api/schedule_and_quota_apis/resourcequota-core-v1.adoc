...
| 200 - OK
| xref:../objects/index.adoc#resourcequotalist-core-v1[`ResourceQuotaList core/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../schedule_and_quota_apis/resourcequota-core-v1.adoc#resourcequota-core-v1[`ResourceQuota core/v1`]
| 
|===
