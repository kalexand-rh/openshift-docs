...
| Parameter | Type | Description
| `body`
| xref:../security_apis/serviceaccount-core-v1.adoc#serviceaccount-core-v1[`ServiceAccount core/v1`]
| 
|===
...
| Parameter | Type | Description
| `body`
| xref:../objects/index.adoc#tokenrequest-authentication-k8s-io-v1[`TokenRequest authentication.k8s.io/v1`]
| 
|===
