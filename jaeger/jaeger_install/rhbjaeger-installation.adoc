...
* If you do not want to install a service mesh, you can use the Jaeger Operator to install {JaegerName} by itself.  To install Jaeger without a service mesh, use the following instructions.
