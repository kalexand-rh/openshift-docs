...
Create a `ServiceMeshMemberRoll` resource to specify the namespaces associated with the {OSSMShortName}. For more information, see xref:../../service_mesh/v2x/ossm-create-mesh.adoc#ossm-create-mesh[Adding services to a service mesh].
