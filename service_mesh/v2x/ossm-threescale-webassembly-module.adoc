...
[NOTE]
====
The `threescale-wasm-auth` module runs on integrations of 3scale API Management 2.11 or later with {OSSMName} 2.1.0 or later.
====
...
Because of its self-contained design, it is possible to configure this module to work with Proxy-WASM proxies independently of {OSSMShortName}, as well as 3scale Istio adapter deployments.
