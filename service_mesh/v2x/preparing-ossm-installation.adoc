...
Before you can install {OSSMName}, you must subscribe to {product-title} and install {product-title} in a supported configuration.
...
* Install {product-title} {product-version}. If you are installing {OSSMName} on a xref:../../installing/installing-preparing.adoc#supported-installation-methods-for-different-platforms[restricted network], follow the instructions for your chosen {product-title} infrastructure.
...
* xref:../../service_mesh/v2x/installing-ossm.adoc#installing-ossm[Install {OSSMName}] in your {product-title} environment.
