...
Before you can install {OSSMName}, review the installation activities, ensure that you meet the prerequisites:
...
[NOTE]
====
If you are installing {OSSMName} on a xref:../../installing/installing-preparing.adoc#supported-installation-methods-for-different-platforms[restricted network], follow the instructions for your chosen {product-title} infrastructure.
====
+
...
* xref:../../service_mesh/v1x/installing-ossm.adoc#installing-ossm-v1x[Install {OSSMName}] in your {product-title} environment.
