...
You can customize your {OSSMName} by modifying the default {OSSMShortName} custom resource or by creating a new custom resource.

== Prerequisites
* An account with the `cluster-admin` role.
* Completed the xref:../../service_mesh/v1x/preparing-ossm-installation.adoc#preparing-ossm-installation-v1x[Preparing to install {OSSMName}] process.
