...
{OSSMName} provides a platform for behavioral insight and operational control over your networked microservices in a service mesh. With {OSSMName}, you can connect, secure, and monitor microservices in your {product-title} environment.
...
* xref:../../service_mesh/v1x/preparing-ossm-installation.adoc#preparing-ossm-installation-v1x[Prepare to install {OSSMName}] in your {product-title} environment.
