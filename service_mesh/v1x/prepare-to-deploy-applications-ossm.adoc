...
When you deploy an application into the {OSSMShortName}, there are several differences between the behavior of applications in the upstream community version of Istio and the behavior of applications within a {OSSMName} installation.

== Prerequisites

* Review xref:../../service_mesh/v1x/ossm-vs-community.adoc#ossm-vs-community-v1x[Comparing {OSSMName} and upstream Istio community installations]

* Review xref:../../service_mesh/v1x/installing-ossm.adoc#installing-ossm-v1x[Installing {OSSMName}]
