...
The Kiali operator works with the telemetry data gathered in {OSSMName} to provide graphs and real-time network diagrams of the applications, services, and workloads in your namespace.

To access the Kiali console you must have {OSSMName} installed and projects configured for the service mesh.
