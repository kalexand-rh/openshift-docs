...
* link:https://github.com/istio/old_issues_repo/issues/115[{OSSMName} does not support IPv6], as it is not supported by the upstream Istio project, nor fully supported by {product-title}.
