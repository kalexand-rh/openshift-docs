...
== New features {OSSMName} 1.1.17.1
...
== New features {OSSMName} 1.1.17

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.16

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.15

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.14
...
== New features {OSSMName} 1.1.13

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.12

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.11

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.10

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.9

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.8

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.7

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.6

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.5

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

This release also added support for configuring cipher suites.

== New features {OSSMName} 1.1.4
...
[IMPORTANT]
====
These manual steps are required to mitigate this CVE whether you are using the 1.1 version or the 1.0 version of {OSSMName}.
====
...
== New features {OSSMName} 1.1.3

This release of {OSSMName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes.

== New features {OSSMName} 1.1.2

This release of {OSSMName} addresses a security vulnerability.

== New features {OSSMName} 1.1.1

This release of {OSSMName} adds support for a disconnected installation.

== New features {OSSMName} 1.1.0

This release of {OSSMName} adds support for Istio 1.4.6 and Jaeger 1.17.1.

[id="ossm-manual-updates-1.0-1.1_{context}"]
=== Manual updates from 1.0 to 1.1

If you are updating from {OSSMName} 1.0 to 1.1, you must update the `ServiceMeshControlPlane` resource to update the control plane components to the new version.

. In the web console, click the {OSSMName} Operator.
...
. Click YAML and add a version field to the `spec:` of your `ServiceMeshControlPlane` resource. For example, to update to {OSSMName} 1.1.0, add `version: v1.1`.
...
The version field specifies the version of {OSSMShortName} to install and defaults to the latest available version.

[NOTE]
====
Note that support for {OSSMName} v1.0 ended in October, 2020.  You must upgrade to either v1.1 or v2.0.
====
