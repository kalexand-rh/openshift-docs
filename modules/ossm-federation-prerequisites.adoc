...
The {OSSMName} federated approach to joining meshes has the following prerequisites:

* Two or more {product-title} 4.6 or above clusters.
* Federation was introduced in {OSSMName} 2.1. You must have the {OSSMName} 2.1 Operator installed on each mesh that you want to federate.
