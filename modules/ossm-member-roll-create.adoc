...
= Creating the {OSSMName} member roll
...
You can add one or more projects to the {OSSMShortName} member roll from the web console. In this example, `istio-system` is the name of the control plane project.
