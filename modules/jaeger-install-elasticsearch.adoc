...
[NOTE]
====
The Elasticsearch installation requires the *openshift-operators-redhat* namespace for the OpenShift Elasticsearch Operator. The other {OSSMName} operators are installed in the `openshift-operators` namespace.
====
+
