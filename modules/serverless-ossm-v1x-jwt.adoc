...
= Using JSON Web Token authentication with {OSSMShortName} 1.x and {ServerlessProductName}

You can use the following procedure to enable using JSON Web Token authentication with {OSSMShortName} 1.x and {ServerlessProductName}.
