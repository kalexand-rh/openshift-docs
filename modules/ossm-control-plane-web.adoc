...
. Click the {OSSMName} Operator, then click *Istio Service Mesh Control Plane*.
...
+
You can configure `ServiceMeshControlPlane` settings later. For more information, see Configuring {OSSMName}.
+
.. Click *Create*. The Operator creates pods, services, and {OSSMShortName} control plane components based on your configuration parameters.
