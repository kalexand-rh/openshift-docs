...
= Integrate the 3scale adapter with {OSSMName}
...
[NOTE]
====
To configure the 3scale Istio Adapter, refer to {OSSMName} custom resources for instructions on adding adapter parameters to the custom resource file.
====
